    ...
    <GlassCard className="h-full">
      <div className="h-full flex flex-col p-6">
        ...
        <div className="grid grid-cols-2 gap-3 h-full">
          <Link
            href="/opportunities"
            className="group flex flex-col items-center justify-center p-4 rounded-xl bg-accent/30 hover:bg-accent border border-border/50 hover:border-primary/30 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
          ...
          <Link
            href="/assistant"
            className="col-span-2 group flex items-center justify-between px-6 py-3 rounded-xl bg-gradient-to-r from-primary/10 to-transparent hover:from-primary/20 border border-primary/20 hover:border-primary/50 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
